...
Private Sub dbg_ReadyToRun()
    ...
    'bp = dbg.ResolveExport("kernel32", "GetProcAddress")
    'dp "GetProcAddress = 0x" & Hex(bp)

    'dp "Injecting Winmain.dll worked? " & dbg.InjectDLL( app.path & "\..\..\..\winmain.dll")
